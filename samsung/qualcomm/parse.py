...
parser.add_argument("-d", "--dir_extract", action="store_true", help="set to parse all trusted applications in a directory")
...
if args.dir_extract:
    ...
    if args.path.endswith("mdt"):
        ta_name = args.path.split(".mdt")[0]
    elif args.path.endswith("mbn"):
        ta_name = args.path.split(".mbn")[0]
    else:
