...
# https://github.com/srlabs/extractor/blob/5ceb668e8bd16b5832e6d049c1b4238366e4c6fb/erofs_tool.py#L497
...
class Erofs:
    def __init__(self, fn):
        if type(fn) == str:
            ...
            self.file_handle = fn
            self.file_size = self.file_handle.getbuffer().nbytes
            self.mmap = self.file_handle.read()
